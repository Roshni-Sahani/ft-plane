    ...
    <div className=" pt-5 ">
      <div className="max-w-[1140px] px-3 mx-auto">
        <div className="flex flex-wrap flex-row py-5 ">
          <div
            className="md:w-5/12 w-full px-3 mb-8 md:mb-0"
            data-aos="zoom-in"
            data-aos-duration="3000"
          >
            <div className="flex items-center gap-2">
              <img src={logo} alt="logo" />
              <h2 className='text-white font-montserrat "text-sm/[22px] font-extrabold leading-7'>
                FT PLANE
              </h2>
            </div>
            <p className="text-[#A7A7A7] text-base font-montserrat font-normal max-w-72 pt-4">
          ...
          <div className="md:w-7/12 w-full px-3">
            <div className="flex flex-wrap flex-row">
              <div
                className="sm:w-4/12 w-1/2 md:px-3 px-0 "
                data-aos="zoom-in"
                data-aos-duration="3000"
              >
                <h2 className="text-white font-montserrat font-bold sm:text-2xl text-xl">
                  Address
                </h2>
                <ul>
                  <li className="pt-1">
                    <a
                      href=""
                      className="text-[#A7A7A7] text-base font-normal font-montserrat hover:text-[#313EF7] relative after:absolute after:w-0 after:h-[2px] hover:after:absolute after:bottom-[-3px] hover:after:w-full after:left-[50%] transition-all duration-500 after:hover:left-0 after:transition-all after:duration-500 hover:after:bg-[#313EF7] "
                    >
                      Integrations
                    </a>
                  </li>
              ...
              <div
                className="sm:w-4/12 w-1/2 px-3 "
                data-aos="zoom-in"
                data-aos-duration="3000"
              >
                <h2 className="text-white font-montserrat font-bold text-xl sm:text-2xl">
                  About
                </h2>
                <ul>
                  <li className="pt-2">
              ...
              <div
                className="sm:w-4/12 w-full md:px-3 px-0 "
                data-aos="zoom-in"
                data-aos-duration="3000"
              >
                <h2 className="text-white font-montserrat font-bold text-xl sm:text-2xl">
        ...
        <div className="flex justify-center items-center gap-1 pt-5 pb-4">
          <p className="text-white font-montserrat text-sm">Copyright </p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="15"
            height="15"
