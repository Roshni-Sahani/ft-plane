...
import cardimg from '../assets/images/png/cardsimg.png'
    ...
    <div className="bg-[#010223] overflow-hidden">
      <div className=" max-w-[1040px] mx-auto px-3 py-[50px] lg:pb-20">
        <div className=" flex flex-wrap flex-row -mx-3">
          <div
            className="lg:w-1/2 flex max-lg:ju stify-center flex-col max-lg:it ems-center w-full px-3"
            data-aos="fade-up-right"
            data-aos-duration="3000"
          >
            <h2 className=" text-white sm:text-[40px] text-2xl font-bold sm:leading-[60px] leading-[30px] tracking-[0.6px]  lg:max-w-[496px]">
          ...
          <div
            className="lg:w-1/2  w-full px-3 relative z-[1]"
            data-aos="fade-up-left"
            data-aos-duration="3000"
          >
            <Slider {...settings} ref={first} className="mx-auto">
            ...
            <div className="  flex gap-[11px] absolute xl:right-[-12%] right-[1%] bottom-[0%] items-center   flex-col text-end justify-content-end">
              <button
            ...
            <img
              src={cardlayer}
              alt="cardlayer"
              className=" hidden sm:block absolute xl:max-w-[450px] max-w-[360px]  md:max-w-[378px] lg:left-[6%] left-[8%] top-[4%] lg:top-[4%] h-[520px] z-[-1]"
            />
          </div>
        </div>
      </div>
