      ...
      <div className="max-w-[1140px] px-3 mx-auto -translate-y-56 min-[1135px]:pt-28 xl:pt-5 md:pt-20 pt-5 -mb-52">
        <div className="bg-[#fff] rounded-[20px_20px_0px_0px] flex max-w-lg h-14 gap- 2 0 border-b border-[#F3F4F6] ">
          <div
            ...
            className={`${
              active === "tab1" ? "bg-[#313EF7] text-white" : "text-[#030522]"
            }  lg:w-4/12 w-1/2 px-3 rounded-[20px_2px_0px_0px] flex justify-center items-center after:h-11  relative  after:w-px after:top-[-6] after:bg-[#F3F4F6] after:right-0 after:absolute  `}
          >
            <button className="font-semibold text-lg font-Montserrat">
              Economy
            </button>
          </div>
          <div
            ...
            className={`${
              active === "tab2" ? "bg-[#313EF7] text-white" : "text-[#030522]"
            }  lg:w-4/12 w-1/2 px-3 flex justify-center items-center  after:h-11 after:w-px after:top-[-6] after:bg-[#F3F4F6] relative after:right-0 after:absolute `}
          >
            <button className="font-semibold text-lg font-Montserrat">
              Busniness{" "}
            </button>
          ...
          <div
            ...
            className={`${
              active === "tab3" ? "bg-[#313EF7] text-white" : "text-[#030522]"
            }  lg:w-4/12 w-1/2 px-3 rounded-[0px_20px_0px_0px] flex justify-center items-center`}
          >
            <button className="font-semibold text-lg font-Montserrat">
              First
            </button>
        ...
        {active === "tab1" ? (
          <div className="rounded-[0px_20px_20px_20px] bg-[#fff] shadow-[0px_100px_200px_0px_#0117361A] justify-center ">
            <div className="flex flex-wrap flex-row py-5 justify-center ">
              <div className="lg:w-3/12 sm:w-1/2 w-full max-sm:justify-center px-3 flex lg:justify-center mb-4 lg:mb-0">
                <div className="flex items-center gap-3 w-[507px]">
                  ...
                  <div>
                    <h2 className="text-[#030522]  font-Montserrat font-semibold text-lg ">
                      Location
                    </h2>
                    <p className="text-[#AEB5BF] font-Montserrat font-normal text-base">
                      Where are you going?
                    </p>
                  </div>
                </div>
              </div>
              <div className="lg:w-3/12 sm:w-1/2 max-sm:justify-center w-full px-3 flex lg:justify-center mb-4 lg:mb-0">
                <div className="flex items-center gap-3 w-[507px]">
                  <div className="w-14 h-14  rounded-[56px] bg-[#f5f5ff] flex items-center justify-center">
                    <svg
                      width="24"
              ...
              <div className="lg:w-3/12 sm:w-1/2 w-full max-sm:justify-center px-3 flex lg:justify-center">
                <div className="flex items-center gap-3 w-[507px]">
                  <div className="w-14 h-14  rounded-[56px] bg-[#f5f5ff] flex items-center justify-center mb-4 lg:mb-0">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
              ...
              <div className="flex items-center  justify-center py-5">
                <button className="text-white font-Montserrat font-semibold text-base rounded-[56px]  bg-[#313EF7] border-[2px] border-transparent hover:border-[#313EF7] hover:bg-transparent hover:text-[#313EF7] duration-300 px-11 py-3.5 mt-3 shadow-[0px_10px_14px_0px_#313EF740]">
                  Book Now
                </button>
              </div>
            </div>
        ...
        {active === "tab3" ? (
          <div className="rounded-[0px_20px_20px_20px] bg-[#fff] shadow-[0px_100px_200px_0px_#0117361A] justify-center ">
            <div className="flex flex-wrap flex-row py-5 justify-center ">
              ...
              <div className="lg:w-3/12 sm:w-1/2 w-full justify-center sm:justify-start px-3 flex lg:justify-center">
                <div className="flex items-center gap-3 w-[507px] mx-auto">
                  <div className="w-14 h-14  rounded-[56px] bg-[#f5f5ff] flex items-center justify-center ">
                    <svg
                      width="24"
                      height="24"
              ...
              <div className="flex items-center  justify-center py-5">
                <button className="text-white font-Montserrat font-semibold text-base rounded-[56px]  bg-[#313EF7] border-transparent px-11 py-3.5 mt-3 border-[2px] shadow-[0px_10px_14px_0px_#313EF740] hover:border-[#313EF7] hover:bg-transparent hover:text-[#313EF7] duration-300">
                  Book Now
                </button>
              </div>
            </div>
